...
/// ## References
///
/// * [medium article](https://medium.com/@tahabebek/swift-macros-36417a8557a)
///
...
/// ## References
///
/// * See [@freestanding(declaration)](https://medium.com/@tahabebek/swift-macros-36417a8557a) in this article for
/// an example that replaces source with other source
///
...
public struct DebugLoggerMacro: MemberMacro {
    public static func expansion(
        ...
        let printFunc = try FunctionDeclSyntax(
