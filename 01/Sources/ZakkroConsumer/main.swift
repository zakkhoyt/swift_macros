...
let (value, string) = #stringify(a + b)
print("The value \(value) was produced by the code \"\(string)\"")

let tuple01 = #stringify("a" + "b")
print("The value \(tuple01.0) was produced by the code \"\(tuple01.1)\"")
